...
export const DOMESTICO_TEMPLATE = `MODELO DE CONTRATO DE TRABALHO DOMESTICO
...
export const RURAL_TEMPLATE = `MODELO DE CONTRATO DE TRABALHO RURAL
...
export const URBANO_TEMPLATE = `MODELO DE CONTRATO DE TRABALHO URBANO
